...
import com.trionmyanmar.sunshine.app.data.WeatherContract;
...
public class FatchWeatherTask extends AsyncTask<String,Void,String[]> {
    ...
    public FatchWeatherTask(Context context) {
        mContext = context;
    }
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharePrefs.getString(
                ...
                mContext.getString(R.string.pref_units_matrice));

        if(unitType.equals(mContext.getString(R.string.pref_units_imperal))){
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        }
        else if(!unitType.equals(mContext.getString(R.string.pref_units_matrice))){
