...
import com.trionmyanmar.sunshine.app.sync.SunshineSyncAdapter;

import java.io.IOException;


public class MyActivity extends AppCompatActivity implements ForecastFragment.Callback {
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        ...
        // that it is private!
        return getSharedPreferences(MyActivity.class.getSimpleName(), Context.MODE_PRIVATE);
    }
